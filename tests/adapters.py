...
def run_multihead_self_attention(
    ...
    """
    attention = transformer.MultiHeadSelfAttention(d_model, num_heads)
...
def run_multihead_self_attention_with_rope(
    ...
    attention = transformer.MultiHeadSelfAttention(d_model, num_heads, rope)
    attention.load_state_dict({"q_proj.weight": q_proj_weight, "k_proj.weight": k_proj_weight, "v_proj.weight": v_proj_weight, "output_proj.weight": o_proj_weight})
...
def run_transformer_block(
    ...
    """
    rope = transformer.RotaryPositionalEmbedding(theta, d_model // num_heads, max_seq_len)
    block = transformer.TransformerBlock(d_model, num_heads, d_ff, rope)
...
def run_transformer_lm(
    ...
    """
    transformer_lm = transformer.TransformerLM(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return optimizer.learning_rate_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
